    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
        ...
        hover:text-slate-700 text-sm mb-10 transition-colors"
          ...
          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl font-meduim text-zinc-800">
              {title}
            </h1>
            <p className="text-slate-500 text-sm sm:text-basemt-2">
              {subtitle}
            </p>
          </div>
          {error && (
            <div
              className="mb-6 p-4 bg-rose-200 border-rose-500
            text-rose-900 text-sm rounded-xl flex items gap-3"
            >
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label
                className="block text=sm font-meduim text-slate-700
               mb-2"
              >
                Email address
              </label>
