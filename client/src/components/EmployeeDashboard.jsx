...
import { Banknote, CalendarIcon, FileTextIcon } from "lucide-react";
    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mt-8">
        {cards.map((card, index) => (
          ...
          realtive overflow-hidden group flex items-center justify-between"
          >
            <div>
              <div
                className="absolute left-0 top-0 bottom-0 w-1 rouded-r-full bg-slate-500/70
              group-hover:text-indigo-500/70"
              />
              <p
            ...
            <card.icon
              className="size-10 p-2.5 rounded-lg bg-slate-100 text-slate-600
