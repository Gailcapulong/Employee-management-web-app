  ...
  const portalOptions = [
    {
      ...
      title: "Admin portal",
      description:
        "Manage employees, deaprtments, payroll and system configuration",
      icon: ShieldIcon,
    },
    {
      to: "/login/employee",
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-slate-500">
              Select your portal securely access the system
            </p>
          </div>
            ...
            {portalOptions.map((portal) => (
              ...
              >
                <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
                  ...
                  group-hover:text-indigo-600 mb-1 transition-colors"
                  >
                    {portal.title}
                  </h3>
                  <ArrowRightIcon
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>
              © {new Date().getFullYear()} LVY Construction Services. All rights
              reserved.
            </p>
          </div>
        </div>
